...
-- Generation Time: Aug 26, 2025 at 06:35 AM
...
INSERT INTO `chat_session` (`user_id`, `started_at`, `updated_at`, `summary`) VALUES
(3, '2025-08-14 15:16:23', '2025-08-14 15:27:20', 'การสนทนาก่อนหน้านี้ไม่สามารถเรียกคืนได้ แต่จากข้อมูลสรุปที่มีในระบบ คุณมีข้อมูลเกี่ยวกับการเพิ่มน้ำหนัก การนอนหลับ และคำแนะนำทางโภชนาการทั่วไป เพื่อช่วยให้คุณนอนหลับได้ดี ควรปฏิบัติตามขั้นตอนเหล่านี้: 1. หลีกเลี่ยงการรับประทานอาหารหนักหลังเวลาเย็น เพื่อให้ร่างกายพร้อมสำหรับการพักผ่อน 2');
...
CREATE TABLE `daily_nutrition_summary` (
  ...
  `target_cal` int(11) DEFAULT NULL,
  `target_fat` int(11) DEFAULT NULL,
  `target_carb` int(11) DEFAULT NULL,
  `target_protein` int(11) DEFAULT NULL,
  `recommendation` text DEFAULT NULL,
  `weight` decimal(5,2) DEFAULT NULL,
  `total_carbs` int(11) NOT NULL,
  `recommended_cal` int(11) DEFAULT NULL,
  `recommended_carb` int(11) DEFAULT NULL,
  `recommended_protein` int(11) DEFAULT NULL,
  `recommended_fat` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 3, '2025-08-23', 350, 11, 15, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(3, 3, '2025-08-24', 1017, 36, 43, 2223, 57, 181, 117, NULL, NULL, 107, NULL, NULL, NULL, NULL),
(5, 3, '2025-08-25', 2873, 95, 180, 2223, 55, 178, 125, NULL, NULL, 248, NULL, NULL, NULL, NULL),
(6, 3, '2025-08-25', 2873, 95, 180, NULL, NULL, NULL, NULL, NULL, NULL, 248, NULL, NULL, NULL, NULL),
(7, 3, '2025-08-26', 2223, 57, 117, 2223, 57, 181, 117, NULL, NULL, 181, 2223, 290, 73, 86);
...
(5, 'example ', '/blog/1753776887832-1f0ntsi82.jpg', '2025-07-29 00:00:00', 'pending', '<p>Welcome to TinyMCE!&nbsp;<br>บทความการกินอาหาร</p>', 'example description', '2025-07-29 15:14:47', '2025-08-03 23:02:02'),
...
(15, 3, '2025-08-17', 'ข้าวหมา', 'มื้อเช้า', 300, 20, 30, 40, '07:30:00', '/images/user_foods/1755072294286_549810228.jpeg', ''),
(16, 3, '2025-08-17', 'ข้าวหมา', 'มท้อ', 300, 20, 30, 40, '16:19:00', '/images/user_foods/1755072294286_549810228.jpeg', ''),
...
(19, 3, '2025-08-18', 'ข้าวหมา', 'มื้อเช้า', 300, 20, 30, 40, '07:30:00', '/images/user_foods/1755072294286_549810228.jpeg', NULL),
...
(61, 3, '2025-08-24', 'ข้าวต้มไข่เจียว', 'มื้อเช้า', 350, 50, 20, 15, '07:30:00', NULL, NULL),
(66, 3, '2025-08-23', 'ผัดไทย', 'มื้อเช้า', 350, 45, 11, 15, '07:30:00', NULL, NULL),
...
(83, 3, '2025-08-25', 'ข้าวหมา', 'มื้อเช้า', 300, 20, 30, 40, '07:30:00', NULL, '24001'),
(84, 3, '2025-08-25', 'ข้าวต้มไข่เจียว', 'มื้อกลางวัน', 350, 50, 10, 15, '12:30:00', NULL, '24101'),
...
(1, 'ข้าวผัดหมู', 550.00, 65.00, 20.00, 15.00, '/foods/1753376625003-cv634ylfb.jpg', ''),
(2, 'ข้าวมันไก่', 600.00, 55.00, 25.00, 30.00, '/foods/1750673087601-h8pdg0d6m.jpg', ''),
...
(21, 'ถั่วเหลืองผัดลำพัง', 450.00, 45.00, 28.00, 15.00, NULL, 'ถั่วเหลือง, ลำพัง, พริกไทย, น้ำล่น, ข้าวเหนียว, ผงขม, น้ำตาล, เกลือ'),
(22, 'ส้มั๊กผักชีแก้ง', 300.00, 35.00, 15.00, 5.00, NULL, 'ย่างมะเขือเทศ, พริกไทย, ผักชี, น้ำตาล, เกลือ, ข้าวเหนียว, น้ำตาล'),
(23, 'ค็อกเทลไก่ท้ออิเล็กทรอนิกส์', 400.00, 20.00, 15.00, 35.00, NULL, 'ไก่ท้อ, น้ำตาล, มะเขือเทศ, พริกไทย, เกลือ'),
(24, 'ข้าวเหนียวถั่วเหลืองเบียร์', 350.00, 55.00, 10.00, 15.00, NULL, 'ข้าวเหนียว, ถั่วเหลือง, เบอร์เกอร์, น้ำตาล, ผงขม'),
(25, 'พริกหมูลำพังที่มีอะโอนิเมนท็อป', 500.00, 40.00, 30.00, 20.00, NULL, 'หมู, ลำพัง, อะโอนิเมนท็อป, น้ำตาล, พริกไทย, น้ำล่น'),
(26, 'ส้มตำผักขาว', 200.00, 30.00, 10.00, 8.00, NULL, 'พริกไทย สงบ ผักขาว นมปูน'),
(27, 'น้ำตาลโหระพา', 180.00, 40.00, 5.00, 3.00, NULL, 'เนย น้ำตาล น้ำมันควัน'),
(28, 'มะนาวชีสหมึก', 220.00, 25.00, 15.00, 10.00, NULL, 'มะนาว ไข่ หมึก พริกไทย น้ำมัน'),
(29, 'แกงจิ้มตาโหระพา', 240.00, 35.00, 18.00, 12.00, NULL, 'ข้าวหมึก ตาโหระพาสำหรับตาโหระพา น้ำมะนาว เกลือ'),
(30, 'ส้มตำอีโอโทเคิล', 150.00, 20.00, 7.00, 6.00, NULL, 'ช็อกโกแลต สงบ อีโอโทเคิล น้ำมันถั่วมะกอก'),
(31, 'ข้าวเหนียวและมะเขือเทศส้มควัน', 550.00, 65.00, 15.00, 10.00, NULL, 'ข้าวเหนียว, มะเขือเทศส้มควัน, น้ำมันมะกอก, ไข่'),
(32, 'ลำพังผักชี', 400.00, 45.00, 10.00, 20.00, NULL, 'ผักชี, แขส, น้ำมันมะกอก, ไข่'),
(33, 'ลำพังไก่กับใบโหระพา', 600.00, 50.00, 20.00, 35.00, NULL, 'ไก่, ใบโหระพา, ข้าวเหนียวสลัด, น้ำมันมะกอก, กระเทียم'),
(34, 'ปังผักไทย', 300.00, 35.00, 5.00, 15.00, NULL, 'ข้าวเหนียว, ไทน์, ขมิ้น, กะหล่ำ, น้ำมะนาว'),
(35, 'หมูกับกุ้งหอม', 750.00, 25.00, 35.00, 30.00, NULL, 'หมู, กุ้งหอม, น้ำมะนาว, ผัก, ข้าวเหนียว'),
(36, 'แกงจานมะเขือเทศดำ', 320.00, 20.00, 15.00, 25.00, NULL, 'ข้าวเหนียว, มะเขือเทศดำ, ไก่, ถั่วต้ม'),
(37, 'พาสเทอร์ทาโหมแดง', 450.00, 60.00, 25.00, 20.00, NULL, 'ปากิสเนตร, ถั่วต้ม, พาสเทอร์ทา'),
(38, 'อาหารพริกแห้งหวาน', 280.00, 30.00, 10.00, 15.00, NULL, 'พริกย่าง, พริกผัก, ผงสับ, น้ำมะนาว'),
(39, 'แช่บีโอลิซันดา', 410.00, 45.00, 20.00, 25.00, NULL, 'ปอกเกอร์, องค์ที่ละมะม่วง, สลัดชีส'),
(40, 'ข้าวเหนียวส้มแซด', 350.00, 70.00, 5.00, 10.00, NULL, 'ข้าวเหนียว, น้ำตาลนม, ปริมาณพอเหมาะ'),
(42, 'ข้าวผัดกุ้ง', 490.00, 60.00, 15.00, 30.00, NULL, 'ข้าว ผัก กุ้ง ส้มกรั่ว'),
(43, 'ข้าวเหนียวและมะเขือเทศ', 350.00, 60.00, 10.00, 8.00, NULL, 'ข้าวเหนียว, มะเขือเทศสด, น้ำตาล, น้ำส้มผสม'),
(44, 'กาดูซึ้ง', 450.00, 40.00, 30.00, 15.00, NULL, 'ข้าวกล้วย, แซลมินธอร์, ไชย์ซิเนดา, น้ำตาล, น้ำมะนาว'),
(45, 'ส้มแห้ง', 300.00, 45.00, 5.00, 10.00, NULL, 'อำลาสด, น้ำตาล, น้ำวานิลลา'),
(46, 'ข้าวเหนียวหวาน', 450.00, 60.00, 10.00, 15.00, NULL, 'ข้าวเหนียว, น้ำตาล, วุ้นช้าง, น้ำคม'),
(47, 'ผักกาดลัดไทย', 350.00, 30.00, 10.00, 20.00, NULL, 'ผักเขียว, กาดลัด, น้ำปลา, ผงพริก'),
(48, 'แกงมะเขือเทศ', 400.00, 40.00, 15.00, 10.00, NULL, 'มะเขือเทศ, หัวหอม, ไข่, ปลาหมึก'),
(49, 'แกงผักลมห้า', 300.00, 35.00, 5.00, 20.00, '/foods/1750673065182-gsa2mykjt.jpg', 'ชิ้นปลาจริง, หัวหอม, แก้วมะเขือเทศ, ผักต้ม'),
(51, 'ข้าวขาหมู', 120.00, 21.00, 10.00, 20.00, '/foods/1751358064771-dsxtvqlvo.jpg', ''),
(52, 'เมนู', 6.00, 0.00, 1.00, 0.00, '/foods/1754279460907-yotzqo1lu.jpg', 'ไก่,ไข่'),
(53, 'เมนูใหม่ๆ-', 10.00, 10.00, 10.00, 10.00, '/foods/1755067493006-owd5dlb01.jpg', 'เนื้อ, หมู, ผัก');
...
(2, 'plan2', 7, NULL, '2025-07-01', '/mealplan/1751358130437-z4zdt81h3.jpg'),
(4, 'plan4', NULL, 'des4', '2025-07-24', '/mealplan/1753517956229-gfb74apoo.jpg'),
(6, 'plan6 ', 7, 'des6', '2025-07-24', '/mealplan/1753371677081-jbnk2ll38.jpg'),
(7, 'plan7', NULL, 'plan8', '2025-07-24', NULL),
(8, 'plan8', NULL, 'plan8', '2025-07-24', NULL),
(9, 'plan9', NULL, 'plan9', '2025-07-24', NULL),
(14, 'planTest', 7, 'planTest description ', '2025-07-26', '/mealplan/1753769408760-6fppop7wc.jpg'),
(17, 'plan-test-2', 7, 'เพิ่มน้ำหนัก', '2025-07-28', '/mealplan/1753769400469-mp1vj83h3.jpg'),
(18, 'plan999', 7, '444', '2025-08-04', '/mealplan/1754279532569-v51t91fuj.jpg');
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `created_date`, `age`, `weight`, `last_updated_weight`, `height`, `gender`, `body_fat`, `target_goal`, `target_weight`, `activity_level`, `additional_requirements`, `dietary_restrictions`, `eating_type`, `account_status`, `suspend_reason`, `updated_at`, `last_password_reset`, `first_time_setting`) VALUES
(3, 'suchao', 'suchao0101@gmail.com', '$2b$10$zr514Sonkl.QNIBCTthQuea2XP.5shex1Wp0R3.ekYHO/G1.v9VH2', '2025-06-27 13:42:26', 2003, 52.00, 52.00, 163.00, 'male', 'normal', 'healthy', 52.00, 'moderate', NULL, '', 'omnivore', 'active', NULL, '2025-08-26 12:21:49', '2025-08-04 06:21:51', 1),
(4, 'tawan', 't@w.com', '$2b$10$hhvit3x73v/.PLaSCHONBuilIZRLkefhdKPhbeHPs1bzJklc00mTC', '2025-06-28 13:01:46', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'suspended', 'upload weird pic\n', '2025-08-03 22:26:54', NULL, 0),
(5, 'suchao01', 'suchaocloud@gmail.con', '$2b$10$Pd1jmJoErJKzmW32gU7N0.puP4vYVzYsefpyhHi0OPNNrLKyOwfXi', '2025-07-01 15:14:44', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, NULL, 0),
(6, 'suchao0001', 'suchaocloud@gamil.com', '$2b$10$POJJVzwjcLnGI9eTNkVpx.DkVm/ju/9WYNdlFk2BHBHy9bB9bpbRK', '2025-08-04 06:23:53', 22, 52.00, 52.00, 163.00, 'male', 'unknown', 'healthy', 52.00, 'moderate', NULL, '', 'omnivore', 'active', NULL, '2025-08-13 09:52:03', NULL, 1),
(7, 'suchao02', 'suchaocloud555@gmail.com', '$2b$10$hv0X04igGRP0DSE50LJBVO1Fbcs04RfT4Z23d8fNLOeOXwTSFu34y', '2025-08-04 10:12:40', 30, 52.00, 52.00, 162.00, 'male', 'unknown', 'increase', 103.00, 'high', NULL, 'กลูเตน, ถั่ว', 'omnivore', 'suspended', NULL, '2025-08-04 10:49:23', NULL, 1),
(8, 'suchao3', 'suchao@gmail.com', '$2b$10$O4iFNkDcEkA/xQbZUSGS3eSyY/St/kJtewOrYjVkYZuZ4rcVHN3TK', '2025-08-13 14:15:19', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, NULL, 0);
...
INSERT INTO `user_food` (`id`, `name`, `cal`, `carb`, `fat`, `protein`, `img`, `user_id`, `ingredient`, `src`, `created_at`) VALUES
...
(9, 'แกงมะเขือเทศ', 180.00, 15.00, 10.00, 5.00, NULL, 3, 'มะเขือเทศ, น้ำตาลแดง, กระเทียม, ถั่วหนึ่งช้อน, กากป่วน', 'user', NULL),
...
--
ALTER TABLE `meal_plan_detail`
  MODIFY `detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;
